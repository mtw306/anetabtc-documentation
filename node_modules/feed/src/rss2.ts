...
export default (ins: Feed) => {
  ...
  if (isContent) {
    base.rss._attributes["xmlns:dc"] = "https://purl.org/dc/elements/1.1/";
    base.rss._attributes["xmlns:content"] = "https://purl.org/rss/1.0/modules/content/";
  }

  if (isAtom) {
    base.rss._attributes["xmlns:atom"] = "https://www.w3.org/2005/Atom";
  }
