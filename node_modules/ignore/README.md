<table><thead>
  ...
  <td align="center">
    ...
    <img
      src="https://img.shields.io/npm/dm/ignore.svg"
...
`ignore` is a manager, filter and parser which implemented in pure JavaScript according to the [.gitignore spec 2.22.1](https://git-scm.com/docs/gitignore).
...
- Exactly according to [gitignore man page](https://git-scm.com/docs/gitignore), fixes some known matching issues of fstream-ignore, such as:
...
Usually, you could use [`glob`](https://npmjs.org/package/glob) with `option.mark = true` to fetch the structure of the current directory:
