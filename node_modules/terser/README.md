...
First make sure you have installed the latest version of [node.js](https://nodejs.org/)
...
For example:
    ...
    terser js/file1.js js/file2.js \
             -o foo.min.js -c -m \
             --source-map "root='https://foo.com/src',url='foo.min.js.map'"

The above will compress and mangle `file1.js` and `file2.js`, will drop the
output in `foo.min.js` and the source map in `foo.min.js.map`.  The source
mapping will refer to `https://foo.com/src/js/file1.js` and
`https://foo.com/src/js/file2.js` (in fact it will list `https://foo.com/src`
...
[practical reasons](https://lisperator.net/blog/uglifyjs-why-not-switching-to-spidermonkey-ast/)
