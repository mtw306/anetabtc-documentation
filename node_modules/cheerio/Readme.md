...
> See https://api.jquery.com/attr/ for more information
...
> See https://api.jquery.com/prop/ for more information
...
> See https://api.jquery.com/data/ for more information
...
> See https://api.jquery.com/addClass/ for more information.
...
> See https://api.jquery.com/removeClass/ for more information.
...
> See https://api.jquery.com/toggleClass/ for more information.
...
```xml
$ = cheerio.load('<media:thumbnail url="https://www.foo.com/keyframe.jpg" width="75" height="50" time="12:05:01.123"/>');
```
...
```js
$.xml()
//=>  <media:thumbnail url="https://www.foo.com/keyframe.jpg" width="75" height="50" time="12:05:01.123"/>
```
