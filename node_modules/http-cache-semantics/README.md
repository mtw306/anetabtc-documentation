...
`CachePolicy` tells when responses can be reused from a cache, taking into account [HTTP RFC 7234](https://httpwg.org/specs/rfc7234.html) rules for user agents and shared caches.
