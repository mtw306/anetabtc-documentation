...
If you were to use this library on a website like `https://example.com/dir1/dir1-1/`, you would get results such as:

| Before                                      | After                                |
| :------------------------------------------ | :----------------------------------- |
| `https://example.com/dir1/dir1-2/index.html` | `../dir1-2/`                         |
| `https://example.com/dir2/dir2-1/`           | `/dir2/dir2-1/`                      |
| `https://example.com/dir1/dir1-1/`           | ` `                                  |
| `https://example.com/dir1/dir1-1/`          | `https://example.com/dir1/dir1-1/`   |
| `https://google.com:80/dir/`                 | `//google.com/dir/`                  |
| `../../../../../../../../#anchor`           | `/#anchor`                           |
...
This utility requires [Node.js](https://nodejs.org/) `>= 0.10`. To install, type this at the command line:
```
...
Type: `Object`   
Default value: `{ftp:21, https:80, https:443}`  

Extend the list with any ports you need. Any URLs containing these default ports will have them removed. Example: `https://example.com:80/` will become `https://example.com/`.
...
This will, for example, consider any domains containing `https://www.example.com/` to be related to any that contain `https://example.com/`.
...
Remove empty query variables. Example: `https://domain.com/?var1&var2=&var3=asdf` will become `https://domain.com/?var3=adsf`. This does not apply to unrelated URLs (with other protocols, auths, hosts and/or ports).

#### options.removeRootTrailingSlash
Type: `Boolean`   
Default value: `true`  

Remove trailing slashes from root paths. Example: `https://domain.com/?var` will become `https://domain.com?var` while `https://domain.com/dir/?var` will not be modified.

#### options.schemeRelative
Type: `Boolean`   
Default value: `true`  

Output URLs relative to the scheme. Example: `https://example.com/` will become `//example.com/`.
...
Passed to Node's [`url.parse`](https://nodejs.org/api/url.html#url_url_parse_urlstr_parsequerystring_slashesdenotehost).
...
* 0.2.8 possible [scheme exclusions](https://www.iana.org/assignments/uri-schemes/uri-schemes.xhtml) such as `tel:`
