...
## Installation
To install `node-emoji`, you need [node.js](https://nodejs.org/) and [npm](https://github.com/npm/npm#super-easy-install). :rocket:
...
emoji.get(':fast_forward:') // `.get` also supports github flavored markdown emoji (https://www.emoji-cheat-sheet.com/)
