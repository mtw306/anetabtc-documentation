...
declare module 'fs' {
    ...
    export class Dir implements AsyncIterable<Dirent> {
        ...
        closeSync(): void;
        /**
         * Asynchronously read the next directory entry via [`readdir(3)`](https://man7.org/linux/man-pages/man3/readdir.3.html) as an `fs.Dirent`.
         *
         ...
         * POSIX [`readdir(3)`](https://man7.org/linux/man-pages/man3/readdir.3.html) documentation for more detail.
         *
     ...
     *
     * See also: [`rename(2)`](https://man7.org/linux/man-pages/man2/rename.2.html).
     *
     * ```js
     ...
     *
     * See the POSIX [`rename(2)`](https://man7.org/linux/man-pages/man2/rename.2.html) documentation for more details.
     * @since v0.1.21
     */
     ...
     * in the future.
     *
     * See the POSIX [`truncate(2)`](https://man7.org/linux/man-pages/man2/truncate.2.html) documentation for more details.
     * @since v0.8.6
     * @param [len=0]
     */
     ...
     * given to the completion callback.
     *
     * See the POSIX [`ftruncate(2)`](https://man7.org/linux/man-pages/man2/ftruncate.2.html) documentation for more detail.
     *
     ...
     *
     * See the POSIX [`chown(2)`](https://man7.org/linux/man-pages/man2/chown.2.html) documentation for more detail.
     * @since v0.1.97
     */
     ...
     * given to the completion callback.
     *
     * See the POSIX [`fchown(2)`](https://man7.org/linux/man-pages/man2/fchown.2.html) documentation for more detail.
     * @since v0.4.7
     */
     ...
     *
     * See the POSIX [`lchown(2)`](https://man7.org/linux/man-pages/man2/lchown.2.html) documentation for more detail.
     */
     ...
     *
     * See the POSIX [`lchown(2)`](https://man7.org/linux/man-pages/man2/lchown.2.html) documentation for more details.
     * @param uid The file's new owner's user id.
     * @param gid The file's new group's group id.
     */
     ...
     *
     * See the POSIX [`fchmod(2)`](https://man7.org/linux/man-pages/man2/fchmod.2.html) documentation for more detail.
     * @since v0.4.7
     */
    ...
    /**
     * Asynchronous [`stat(2)`](https://man7.org/linux/man-pages/man2/stat.2.html). The callback gets two arguments `(err, stats)` where`stats` is an `fs.Stats` object.
     *
     ...
     *
     * See the POSIX [`fstat(2)`](https://man7.org/linux/man-pages/man2/fstat.2.html) documentation for more detail.
     * @since v0.1.95
     */
     ...
     *
     * See the POSIX [`lstat(2)`](https://man7.org/linux/man-pages/man2/lstat.2.html) documentation for more details.
     * @since v0.1.30
     */
    ...
    /**
     * Creates a new link from the `existingPath` to the `newPath`. See the POSIX [`link(2)`](https://man7.org/linux/man-pages/man2/link.2.html) documentation for more detail. No arguments other than
     * a possible
     * exception are given to the completion callback.
     * @since v0.1.31
     */
    ...
    /**
     * Creates a new link from the `existingPath` to the `newPath`. See the POSIX [`link(2)`](https://man7.org/linux/man-pages/man2/link.2.html) documentation for more detail. Returns `undefined`.
     * @since v0.1.31
     */
     ...
     * possible exception are given to the completion callback.
     *
     * See the POSIX [`symlink(2)`](https://man7.org/linux/man-pages/man2/symlink.2.html) documentation for more details.
     *
     ...
     *
     * See the POSIX [`readlink(2)`](https://man7.org/linux/man-pages/man2/readlink.2.html) documentation for more details.
     *
     ...
     *
     * This function behaves like [`realpath(3)`](https://man7.org/linux/man-pages/man3/realpath.3.html), with some exceptions:
     *
     * 1. No case conversion is performed on case-insensitive file systems.
     * 2. The maximum number of symbolic links is platform-independent and generally
     * (much) higher than what the native [`realpath(3)`](https://man7.org/linux/man-pages/man3/realpath.3.html) implementation supports.
     *
    ...
    export namespace realpath {
        ...
        function __promisify__(path: PathLike, options?: EncodingOption): Promise<string | Buffer>;
        /**
         * Asynchronous [`realpath(3)`](https://man7.org/linux/man-pages/man3/realpath.3.html).
         *
     ...
     *
     * See the POSIX [`unlink(2)`](https://man7.org/linux/man-pages/man2/unlink.2.html) documentation for more details.
     * @since v0.0.2
     */
    ...
    /**
     * Synchronous [`unlink(2)`](https://man7.org/linux/man-pages/man2/unlink.2.html). Returns `undefined`.
     * @since v0.1.21
     */
    ...
    /**
     * Asynchronous [`rmdir(2)`](https://man7.org/linux/man-pages/man2/rmdir.2.html). No arguments other than a possible exception are given
    ...
    /**
     * Synchronous [`rmdir(2)`](https://man7.org/linux/man-pages/man2/rmdir.2.html). Returns `undefined`.
     *
     ...
     * ```
     *
     * See the POSIX [`mkdir(2)`](https://man7.org/linux/man-pages/man2/mkdir.2.html) documentation for more details.
     * @since v0.1.8
     */
     ...
     *
     * See the POSIX [`readdir(3)`](https://man7.org/linux/man-pages/man3/readdir.3.html) documentation for more details.
     *
     * The optional `options` argument can be a string specifying an encoding, or an
     * object with an `encoding` property specifying the character encoding to use for
     ...
     *
     * See the POSIX [`close(2)`](https://man7.org/linux/man-pages/man2/close.2.html) documentation for more detail.
     * @since v0.0.2
     */
    ...
    /**
     * Asynchronous file open. See the POSIX [`open(2)`](https://man7.org/linux/man-pages/man2/open.2.html) documentation for more details.
     *
     ...
     * Refer to the POSIX [`fsync(2)`](https://man7.org/linux/man-pages/man2/fsync.2.html) documentation for more detail. No arguments other
     ...
     * Request that all data for the open file descriptor is flushed to the storage
     * device. The specific implementation is operating system and device specific.
     * Refer to the POSIX [`fsync(2)`](https://man7.org/linux/man-pages/man2/fsync.2.html) documentation for more detail. Returns `undefined`.
     * @since v0.1.96
     */
     ...
     * at the current position. See [`pwrite(2)`](https://man7.org/linux/man-pages/man2/pwrite.2.html).
     *
     ...
     * operating system's synchronized I/O completion state. Refer to the POSIX [`fdatasync(2)`](https://man7.org/linux/man-pages/man2/fdatasync.2.html) documentation for details. No arguments other
     * than a possible
     * exception are given to the completion callback.
     * @since v0.1.96
     */
    ...
    /**
     * Forces all currently queued I/O operations associated with the file to the
     * operating system's synchronized I/O completion state. Refer to the POSIX [`fdatasync(2)`](https://man7.org/linux/man-pages/man2/fdatasync.2.html) documentation for details. Returns `undefined`.
     * @since v0.1.96
     */
    ...
    /**
     * Synchronously open a directory. See [`opendir(3)`](https://man7.org/linux/man-pages/man3/opendir.3.html).
     *
    ...
    /**
     * Asynchronously open a directory. See the POSIX [`opendir(3)`](https://man7.org/linux/man-pages/man3/opendir.3.html) documentation for
     * more details.
     *
     * Creates an `fs.Dir`, which contains all further functions for reading from
     * and cleaning up the directory.
