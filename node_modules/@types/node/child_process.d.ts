 ...
 * a manner that is similar, but not identical, to [`popen(3)`](https://man7.org/linux/man-pages/man3/popen.3.html). This capability
...
declare module 'child_process' {
    ...
    class ChildProcess extends EventEmitter {
         ...
         * argument is given, the process will be sent the `'SIGTERM'` signal. See [`signal(7)`](https://man7.org/linux/man-pages/man7/signal.7.html) for a list of available signals. This function
         * returns `true` if [`kill(2)`](https://man7.org/linux/man-pages/man2/kill.2.html) succeeds, and `false` otherwise.
         *
         * ```js
         * const { spawn } = require('child_process');
         * const grep = spawn('grep', ['ssh']);
         ...
         *
         * See [`kill(2)`](https://man7.org/linux/man-pages/man2/kill.2.html) for reference.
         *
     ...
     *
     * Unlike the [`exec(3)`](https://man7.org/linux/man-pages/man3/exec.3.html) POSIX system call, `child_process.exec()` does not replace
     ...
     *
     * Unlike the [`fork(2)`](https://man7.org/linux/man-pages/man2/fork.2.html) POSIX system call, `child_process.fork()` does not clone the
     * current process.
     *
