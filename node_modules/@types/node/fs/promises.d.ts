...
declare module 'fs/promises' {
    ...
    interface FileHandle {
        ...
        /**
         * Changes the ownership of the file. A wrapper for [`chown(2)`](https://man7.org/linux/man-pages/man2/chown.2.html).
         * @since v10.0.0
        ...
        /**
         * Modifies the permissions on the file. See [`chmod(2)`](https://man7.org/linux/man-pages/man2/chmod.2.html).
         * @since v10.0.0
         ...
         * operating system's synchronized I/O completion state. Refer to the POSIX [`fdatasync(2)`](https://man7.org/linux/man-pages/man2/fdatasync.2.html) documentation for details.
         *
         ...
         * Refer to the POSIX [`fsync(2)`](https://man7.org/linux/man-pages/man2/fsync.2.html) documentation for more detail.
         * @since v10.0.0
    ...
    /**
     * Reads the contents of the symbolic link referred to by `path`. See the POSIX [`readlink(2)`](https://man7.org/linux/man-pages/man2/readlink.2.html) documentation for more detail. The promise is
    ...
    /**
     * Creates a new link from the `existingPath` to the `newPath`. See the POSIX [`link(2)`](https://man7.org/linux/man-pages/man2/link.2.html) documentation for more detail.
     * @since v10.0.0
     * @return Fulfills with `undefined` upon success.
     */
     ...
     * path that is not a symbolic link, the file is deleted. See the POSIX [`unlink(2)`](https://man7.org/linux/man-pages/man2/unlink.2.html) documentation for more detail.
     * @since v10.0.0
     * @return Fulfills with `undefined` upon success.
     */
    ...
    /**
     * Asynchronously open a directory for iterative scanning. See the POSIX [`opendir(3)`](https://man7.org/linux/man-pages/man3/opendir.3.html) documentation for more detail.
     *
