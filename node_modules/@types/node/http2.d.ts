...
declare module 'http2' {
    ...
    export interface Http2Stream extends stream.Duplex {
         ...
         * ```js
         * const http2 = require('http2');
         * const client = http2.connect('https://example.org:8000');
    ...
    export interface ClientSessionOptions extends SessionOptions {
        ...
        protocol?: 'https:' | 'https:' | undefined;
    }
    ...
    export class Http2ServerRequest extends stream.Readable {
         ...
         * ```console
         * $ node
         * > new URL('/status?name=ryan', 'https://example.com')
         * URL {
         *   href: 'https://example.com/status?name=ryan',
     ...
     * ```
     * @since v8.4.0
     * @param authority The remote HTTP/2 server to connect to. This must be in the form of a minimal, valid URL with the `https://` or `https://` prefix, host name, and IP port (if a non-default port
