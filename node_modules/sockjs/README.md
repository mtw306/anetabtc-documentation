[![NPM version](https://badge.fury.io/js/sockjs.svg)](https://badge.fury.io/js/sockjs)
...
[Streams API](https://nodejs.org/docs/v0.5.8/api/streams.html) or the
[Http.Server API](https://nodejs.org/docs/v0.5.8/api/http.html#http.Server).

### Server class

SockJS module is generating a `Server` class, similar to
[Node.js http.createServer](https://nodejs.org/docs/v0.5.8/api/http.html#http.createServer)
module.
...
[http.Server instance](https://nodejs.org/docs/v0.5.8/api/http.html#http.createServer).
...
[EventEmitter](https://nodejs.org/docs/v0.4.10/api/events.html#events.EventEmitter),
...
[Node Stream API](https://nodejs.org/docs/v0.5.8/api/streams.html) and
...
<dd><a href="https://nodejs.org/docs/v0.4.10/api/http.html#request.url">Url</a>
...
[HAProxy](https://haproxy.1wt.eu/) are able to proxy WebSocket
...
[https://localhost:8080/](https://localhost:8080/) you should be able
