...
> Note that `URLSearchParams` is not supported by all browsers (see [caniuse.com](https://www.caniuse.com/#feat=urlsearchparams)), but there is a [polyfill](https://github.com/WebReflection/url-search-params) available (make sure to polyfill the global environment).
