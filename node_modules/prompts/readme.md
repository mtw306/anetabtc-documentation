...
* **Simple**: prompts has [no big dependencies](https://npm.anvaka.com/#/view/2d/prompts) nor is it broken into a [dozen](https://npm.anvaka.com/#/view/2d/inquirer) tiny modules that only work well together.
