...
function test(globstar) {
  ...
  assertMatch("*.min.js", "https://example.com/jquery.min.js", {globstar: false});
  assertMatch("*.min.*", "https://example.com/jquery.min.js", {globstar: false});
  assertMatch("*/js/*.js", "https://example.com/js/jquery.min.js", {globstar: false});

  // More complex matches with RegExp 'g' flag (complex regression)
  assertMatch("*.min.*", "https://example.com/jquery.min.js", { flags: 'g' });
  assertMatch("*.min.js", "https://example.com/jquery.min.js", { flags: 'g' });
  assertMatch("*/js/*.js", "https://example.com/js/jquery.min.js", { flags: 'g' });
  ...
  assertNotMatch(".min.", "https://example.com/jquery.min.js");
  assertMatch("*.min.*", "https://example.com/jquery.min.js");
  assertMatch(".min.", "https://example.com/jquery.min.js", { flags: 'g' });

  assertNotMatch("https:", "https://example.com/jquery.min.js");
  assertMatch("https:*", "https://example.com/jquery.min.js");
  assertMatch("https:", "https://example.com/jquery.min.js", { flags: 'g' });

  assertNotMatch("min.js", "https://example.com/jquery.min.js");
  assertMatch("*.min.js", "https://example.com/jquery.min.js");
  assertMatch("min.js", "https://example.com/jquery.min.js", { flags: 'g' });

  // Match anywhere (globally) using RegExp 'g'
  assertMatch("min", "https://example.com/jquery.min.js", { flags: 'g' });
  assertMatch("/js/", "https://example.com/js/jquery.min.js", { flags: 'g' });

  assertNotMatch("/js*jq*.js", "https://example.com/js/jquery.min.js");
  assertMatch("/js*jq*.js", "https://example.com/js/jquery.min.js", { flags: 'g' });
  ...
  assertMatch("https://?o[oz].b*z.com/{*.js,*.html}",
              "https://foo.baaz.com/jquery.min.js",
              { extended: true });
  assertMatch("https://?o[oz].b*z.com/{*.js,*.html}",
              "https://moz.buzz.com/index.html",
              { extended: true });
  assertNotMatch("https://?o[oz].b*z.com/{*.js,*.html}",
                 "https://moz.buzz.com/index.htm",
                 { extended: true });
  assertNotMatch("https://?o[oz].b*z.com/{*.js,*.html}",
                 "https://moz.bar.com/index.html",
                 { extended: true });
  assertNotMatch("https://?o[oz].b*z.com/{*.js,*.html}",
                 "https://flozz.buzz.com/index.html",
                 { extended: true });
  ...
  // globstar
  assertMatch("https://foo.com/**/{*.js,*.html}",
              "https://foo.com/bar/jquery.min.js",
              { extended: true,  globstar: globstar, flags: 'g' });
  assertMatch("https://foo.com/**/{*.js,*.html}",
              "https://foo.com/bar/baz/jquery.min.js",
              { extended: true,  globstar: globstar, flags: 'g' });
  assertMatch("https://foo.com/**",
              "https://foo.com/bar/baz/jquery.min.js",
              { extended: true,  globstar: globstar, flags: 'g' });
...
assertMatch("https://foo.com/*/*/jquery.min.js",
            "https://foo.com/bar/baz/jquery.min.js",
            { globstar: true });
assertMatch("https://foo.com/**/jquery.min.js",
            "https://foo.com/bar/baz/jquery.min.js",
...
assertMatch("https://foo.com/*/jquery.min.js",
            "https://foo.com/bar/baz/jquery.min.js",
            { globstar: false });
assertNotMatch("https://foo.com/*/jquery.min.js",
               "https://foo.com/bar/baz/jquery.min.js",
               { globstar: true });
