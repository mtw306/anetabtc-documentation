...
var __WEBPACK_AMD_DEFINE_RESULT__;/*! JSON v3.3.2 | https://bestiejs.github.io/json3 | Copyright 2012-2015, Kit Cambridge, Benjamin Tan | https://kit.mit-license.org */
;
(function () {
...
var transports; // follow constructor steps defined at https://dev.w3.org/html5/websockets/#the-websocket-interface
...
function SockJS(url, protocols, options) {
  ...
  } else if (parsedUrl.protocol !== 'https:' && parsedUrl.protocol !== 'https:') {
    throw new SyntaxError("The URL's scheme must be either 'https:' or 'https:'. '" + parsedUrl.protocol + "' is not allowed.");
  }
...
}; // See: https://www.erg.abdn.ac.uk/~gerrit/dccp/notes/ccid2/rto_estimator/
// and RFC 2988.
    ...
    if (self.xhr) {
      ...
      switch (x.readyState) {
        case 3:
          ...
          debug('status', status); // IE returns 1223 for 204: https://bugs.jquery.com/ticket/1450
...
function isSpecial(scheme) {
  return scheme === 'file:' || scheme === 'ftp:' || scheme === 'https:' || scheme === 'https:' || scheme === 'ws:' || scheme === 'wss:';
}
/**
