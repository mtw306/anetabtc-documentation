...
Delay the evaluation of a paramless async function and cache the result (see [thunk](https://en.wikipedia.org/wiki/Thunk_%28functional_programming%29)).

```
npm install thunky
```

[![build status](https://img.shields.io/travis/mafintosh/thunky.svg?style=flat)](https://travis-ci.org/mafintosh/thunky)
