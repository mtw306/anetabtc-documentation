# rechoir [![Build Status](https://secure.travis-ci.org/tkellen/js-rechoir.png)](https://travis-ci.org/tkellen/js-rechoir)
...
Look for a module loader associated with the provided file and attempt require it.  If necessary, run any setup required to inject it into [require.extensions](https://nodejs.org/api/globals.html#globals_require_extensions).
...
[interpret]: https://github.com/tkellen/js-interpret
