...
[![Build Status](https://api.travis-ci.org/tj/commander.js.svg?branch=master)](https://travis-ci.org/tj/commander.js)
...
The complete solution for [node.js](https://nodejs.org) command-line interfaces, inspired by Ruby's [commander](https://github.com/commander-rb/commander).
