...
If `portfinder.getPortPromise()` is called on a Node version without Promise (<4), it will throw an Error unless [Bluebird](https://bluebirdjs.com/docs/getting-started.html) or any Promise pollyfill is used.
