...
http.get('https://bit.ly/900913', response => {
...
- `agents` (default: `undefined`) – sets the `agent` option per protocol, since HTTP and HTTPS use different agents. Example value: `{ https: new http.Agent(), https: new https.Agent() }`
...
const { http, https } = require('follow-redirects').wrap({
  https: require('your-custom-http'),
