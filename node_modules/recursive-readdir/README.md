...
Because it uses fs.readdir, which calls [readdir](https://linux.die.net/man/3/readdir) under the hood
on OS X and Linux, the order of files inside directories is [not guaranteed](https://stackoverflow.com/questions/8977441/does-readdir-guarantee-an-order).
