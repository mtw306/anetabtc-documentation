declare namespace normalizeUrl {
	interface Options {
		...
		*/
		...
		/**
		Normalizes `https:` URLs to `https:`.
		...
		*/
		...
		@example
		```
		normalizeUrl('https://sindresorhus.com/about.html#:~:text=hello');
		//=> 'https://sindresorhus.com/about.html#'

		normalizeUrl('https://sindresorhus.com/about.html#section:~:text=hello');
		//=> 'https://sindresorhus.com/about.html#section'

		normalizeUrl('https://sindresorhus.com/about.html#:~:text=hello', {stripTextFragment: false});
		//=> 'https://sindresorhus.com/about.html#:~:text=hello'

		normalizeUrl('https://sindresorhus.com/about.html#section:~:text=hello', {stripTextFragment: false});
		//=> 'https://sindresorhus.com/about.html#section:~:text=hello'
		```
		*/
		...
		*/
		...
		//=> 'https://www.sindresorhus.com/?foo=bar&ref=test_ref&utm_medium=test'
		```
		*/
...
//=> 'https://sindresorhus.com/baz?a=foo&b=bar'
```
*/
