...
|------|----|--|-----------|
|url|string|`https://example.com/some/path`|The only required property for every sitemap entry|
...
|ampLink|string|`https://ampproject.org/article.amp.html`||
...
|Option|Type|eg|Description|
|------|----|--|-----------|
|url|string|`https://example.com/image.jpg`|The URL of the image.|
...
|license|string - optional|`https://example.com/license.txt`|A URL to the license of the image.|
...
|------|----|--|-----------|
|lang|string|'en'||
|url|string|`'https://example.com/en/'`||
