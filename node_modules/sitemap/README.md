...
makes creating [sitemap XML](https://www.sitemaps.org/) files easy. [What is a sitemap?](https://support.google.com/webmasters/answer/156184?hl=en&ref_topic=4581190)
...
app.get('/sitemap.xml', function(req, res) {
  ...
  try {
    ...
    smStream.write({ url: '/page-4/',   img: "https://urlTest.com" })
    /* or use
...
smStream.write({
  ...
  video: [
    {
      thumbnail_loc: 'https://test.com/tmbn1.jpg',
      title: 'A video title',
      description: 'This is a video'
    },
    {
      thumbnail_loc: 'https://test.com/tmbn2.jpg',
      title: 'A video with an attribute',
      description: 'This is another video',
      'player_loc': 'https://www.example.com/videoplayer.mp4?video=123',
      'player_loc:autoplay': 'ap=1',
      'player_loc:allow_embed': 'yes'
    }
  ],
  links: [
    { lang: 'en', url: 'https://test.com/page-1/' },
    { lang: 'ja', url: 'https://test.com/page-1/ja/' }
  ],
