...
const urlsetTagStart = '<urlset xmlns="https://www.sitemaps.org/schemas/sitemap/0.9"';
const getURLSetNs = ({ news, video, image, xhtml, custom }, xslURL) => {
    ...
    ns += urlsetTagStart;
    if (news) {
        ns += ' xmlns:news="https://www.google.com/schemas/sitemap-news/0.9"';
    }
    if (xhtml) {
        ns += ' xmlns:xhtml="https://www.w3.org/1999/xhtml"';
    }
    if (image) {
        ns += ' xmlns:image="https://www.google.com/schemas/sitemap-image/1.1"';
    }
    if (video) {
        ns += ' xmlns:video="https://www.google.com/schemas/sitemap-video/1.1"';
    }
    if (custom) {
        ns += ' ' + custom.join(' ');
    }
