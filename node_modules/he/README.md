...
In [Node.js](https://nodejs.org/), [io.js](https://iojs.org/), [Narwhal](https://narwhaljs.org/), and [RingoJS](https://ringojs.org/):
...
```bash
$ curl -sL "https://git.io/HnfEaw" | he --encode > escaped.html
```
...
```bash
$ curl -sL "https://git.io/HnfEaw" | he --decode > decoded.txt
```
