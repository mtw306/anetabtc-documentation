...
In [Node.js](https://nodejs.org/) and [RingoJS](https://ringojs.org/):

```js
var jsesc = require('jsesc');
```

In [Narwhal](https://narwhaljs.org/):
...
**Note:** Using this option on objects or arrays that contain non-string values relies on `JSON.stringify()`. For legacy environments like IE ≤ 7, use [a `JSON` polyfill](https://bestiejs.github.io/json3/).
...
```bash
$ curl -sL "https://git.io/aorKgQ" | jsesc --json --object > data-escaped.json
```
