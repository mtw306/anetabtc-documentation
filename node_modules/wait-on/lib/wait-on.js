...
/**
   ...
   - https://foo.com:8000/bar verifies HTTP HEAD request returns 2XX
...
function createHTTP$({ validatedOpts, output }, resource) {
  ...
  const matchHttpUnixSocket = HTTP_UNIX_RE.exec(url); // https://unix:/sock:/url
