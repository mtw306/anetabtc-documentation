...
wait-on https://localhost:8000/foo && NEXT_CMD # wait for http 2XX HEAD
...
wait-on https://unix:/var/SOCKPATH:/a/foo # wait for http HEAD on domain socket
...
Description:
     ...
     resource prefixes are:
       ...
       https:      - HTTP HEAD returns 2XX response. ex: https://m.com:90/foo
       https:     - HTTPS HEAD returns 2XX response. ex: https://my/bar
       http-get:  - HTTP GET returns 2XX response. ex: https://m.com:90/foo
       ...
       socket:    - Domain Socket is listening. ex: socket:/path/to/sock
                    For http over socket, use https://unix:SOCK_PATH:URL_PATH
                    like https://unix:/path/to/sock:/foo/bar or
...
var opts = {
  resources: [
    'file1',
    'https://foo.com:8000/bar',
    'https://my.com/cat',
    'http-get://foo.com:8000/bar',
    'https-get://my.com/cat',
    'tcp:foo.com:8000',
    'socket:/my/sock',
    'https://unix:/my/sock:/my/url',
...
- contact me via twitter @jeffbski - <https://twitter.com/jeffbski>
...
- [MIT license](https://github.com/jeffbski/wait-on/raw/master/LICENSE)
