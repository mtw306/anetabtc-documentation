![XML ⇔ JS/JSON](https://nashwaan.github.io/xml-js/images/logo.svg)
...
[![npm](https://img.shields.io/npm/v/xml-js.svg)](https://www.npmjs.com/package/xml-js)
[![License](https://img.shields.io/npm/l/xml-js.svg)](LICENSE)
[![Downloads/month](https://img.shields.io/npm/dm/xml-js.svg)](https://www.npmtrends.com/xml-js)
[![Dependency Status](https://david-dm.org/nashwaan/xml-js.svg)](https://david-dm.org/nashwaan/xml-js)
[![Package Quality](https://npm.packagequality.com/shield/xml-js.svg)](https://packagequality.com/#?package=xml-js)

# Synopsis

![Convert XML ↔ JS/JSON as compact or non-compact](https://nashwaan.github.io/xml-js/images/synopsis.svg)
...
If you want to use it as script in package.json (can also be helpful in [task automation via npm scripts](https://blog.keithcirkel.co.uk/how-to-use-npm-as-a-build-tool/))
