...
function hookIntoCompiler (compiler, options, plugin) {
   ...
   * @param { false
            | string
            | {[attributeName: string]: string} // attributes e.g. { href:"https://example.com/page.html" target:"_blank" }
            } baseOption
  * @returns {Array<HtmlTagObject>}
  */
  ...
  */
   ...
   * E.g. https://localhost:8080/ -> https://localhost:8080/?50c9096ba6183fd728eeb065a26ec175
   * @param {string} url
   * @param {string} hash
   */
