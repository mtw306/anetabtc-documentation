...
The project is [unit-tested](https://travis-ci.org/shelljs/shelljs) and battle-tested in projects like:

+ [Firebug](https://getfirebug.com/) - Firefox's infamous debugger
+ [JSHint](https://jshint.com) & [ESLint](https://eslint.org/) - popular JavaScript linters
+ [Zepto](https://zeptojs.com) - jQuery-compatible JavaScript library for modern browsers
+ [Yeoman](https://yeoman.io/) - Web application stack and development tool
+ [Deployd.com](https://deployd.com) - Open source PaaS for quick API backend generation
...
[shelljs.org](https://documentup.com/shelljs/shelljs).
...
Follows Python's [tempfile algorithm](https://docs.python.org/library/tempfile.html#tempfile.tempdir).
...
This is a partial implementation of [`touch(1)`](https://linux.die.net/man/1/touch).
...
| [![Nate Fischer](https://avatars.githubusercontent.com/u/5801521?s=130)](https://github.com/nfischer) | [![Brandon Freitag](https://avatars1.githubusercontent.com/u/5988055?v=3&s=130)](https://github.com/freitagbr) |
|:---:|:---:|
| [Nate Fischer](https://github.com/nfischer) | [Brandon Freitag](https://github.com/freitagbr) |
