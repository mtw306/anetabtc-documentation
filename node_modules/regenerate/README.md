...
In [Node.js](https://nodejs.org/), [io.js](https://iojs.org/), and [RingoJS ≥ v0.8.0](https://ringojs.org/):

```js
var regenerate = require('regenerate');
```

In [Narwhal](https://narwhaljs.org/) and [RingoJS ≤ v0.7.0](https://ringojs.org/):
